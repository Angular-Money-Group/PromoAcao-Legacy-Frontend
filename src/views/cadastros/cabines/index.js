...
const Cabines = () => {
  ...
  const store = useSelector(state => state.cabinsByShip)
    ...
    <Fragment>
      <Card>
        <CardHeader className='border-bottom'>
          <CardTitle tag='h4'>Cabines</CardTitle>
          <div>
            ...
            <Button className='ms-2' color='primary' onClick={handleModal}>
              <Plus size={15} />
              <span className='align-middle ms-50'>Cabine</span>
            </Button>
          </div>
        </CardHeader>
