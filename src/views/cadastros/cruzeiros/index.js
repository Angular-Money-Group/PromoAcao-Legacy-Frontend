...
const Cruzeiros = () => {
  ...
  const store = useSelector(state => state.cruises)
    ...
    <Fragment>
      <Card>
        <CardHeader className='border-bottom'>
          <CardTitle tag='h4'>Cruzeiros</CardTitle>
          <Button className='ms-2' color='primary' onClick={handleModal}>
            <Plus size={15} />
            <span className='align-middle ms-50'>Cruzeiro</span>
          </Button>
        </CardHeader>
