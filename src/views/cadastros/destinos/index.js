...
const Destinos = () => {
  ...
  const store = useSelector(state => state.destinos)
    ...
    <Fragment>
      <Card>
        <CardHeader className='border-bottom'>
          <CardTitle tag='h4'>Destinos</CardTitle>
          <Button className='ms-2' color='primary' onClick={handleModal}>
            <Plus size={15} />
            <span className='align-middle ms-50'>Destino</span>
          </Button>
        </CardHeader>
