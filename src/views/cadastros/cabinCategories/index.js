...
const CabinCategories = () => {
  ...
  const store = useSelector(state => state.cabinCategories)
    ...
    <Fragment>
      <Card>
        <CardHeader className='border-bottom'>
          <CardTitle tag='h4'>Categorias da cabine</CardTitle>
          <div>
            ...
            <Button className='ms-2' color='primary' onClick={handleModal}>
              <Plus size={15} />
              <span className='align-middle ms-50'>Categoria</span>
            </Button>
          </div>
        </CardHeader>
...
export default memo(CabinCategories)
