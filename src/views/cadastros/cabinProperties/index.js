...
const CabinProperties = () => {
  // ** Store Vars
  const dispatch = useDispatch()
  const store = useSelector(state => state.cabinProperties)
    ...
    <Fragment>
      <Card>
        <CardHeader className='border-bottom'>
          <CardTitle tag='h4'>Propriedades da cabine</CardTitle>
          <div>
            ...
            <Button className='ms-2' color='primary' onClick={handleModal}>
              <Plus size={15} />
              <span className='align-middle ms-50'>Propriedade</span>
            </Button>
          </div>
        </CardHeader>
...
export default memo(CabinProperties)
