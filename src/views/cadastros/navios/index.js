...
const Navios = () => {
  ...
  const store = useSelector(state => state.navios)
  ...
  // ** Function to handle Add Modal toggle
    ...
    <Fragment>
      <Card>
        <CardHeader className='border-bottom'>
          <CardTitle tag='h4'>Navios</CardTitle>
          <Button className='ms-2' color='primary' onClick={handleModal}>
            <Plus size={15} />
            <span className='align-middle ms-50'>Navio</span>
          </Button>
        </CardHeader>
