...
// ** Store & Actions
import { getData, getDestinations } from './store'
    ...
    <Fragment>
      <Card>
        <CardHeader className='border-bottom'>
          <CardTitle tag='h4'>Roteiros</CardTitle>
          <Button className='ms-2' color='primary' onClick={handleModal}>
            <Plus size={15} />
            <span className='align-middle ms-50'>Roteiro</span>
          </Button>
        </CardHeader>
