...
import { getItinerary, handleEditModal } from './EditModal/store'
...
export const columns = [
  ...
  },
  {
    ...
    cell: (row) => {
      ...
      const exclusionModalStore = useSelector(state => state.itineraryExclusionModal)
        ...
        <div className='d-flex'>
          <UncontrolledDropdown>
            ...
            <DropdownMenu end>
              ...
              >
                <Edit size={15} />
                <span className='align-middle ms-50'>Editar roteiro</span>
              </DropdownItem>
              <DropdownItem
                tag='a'
                href='/'
              ...
              >
                <Delete size={15} />
                <span className='align-middle ms-50'>Excluir roteiro</span>
              </DropdownItem>
            </DropdownMenu>
          </UncontrolledDropdown>
          <Edit
