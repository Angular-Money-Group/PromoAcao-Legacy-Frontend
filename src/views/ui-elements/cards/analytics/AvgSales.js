      ...
      <CardBody>
        <Row className='pb-50'>
          ...
          >
            <div className='session-info mb-1 mb-lg-0'>
              <h2 className='fw-bold mb-25'>R$ {data.sales}</h2>
              <CardText className='fw-bold mb-2'>Vendas</CardText>
              <h5 className='font-medium-2'>
                <span className='text-success me-50'>{data.growth}</span>
                <span className='fw-normal'>VS últimos 7 dias</span>
              </h5>
            </div>
            <div>
        ...
        <Row className='pt-50'>
          <Col className='mb-2' md='6' sm='12'>
            <p className='mb-50'>Finalizado: R$ {data.goal}</p>
            <Progress className='avg-session-progress mt-25' value='50' />
          </Col>
          <Col className='mb-2' md='6' sm='12'>
            <p className='mb-50'>Clientes: {data.users}</p>
