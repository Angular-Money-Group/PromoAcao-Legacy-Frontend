...
const data = [
  {
    id: 1,
    full_name: "SANTOS / BUZIOS / ILHA BELA / SANTOS",
    status: 1
  },
  {
    id: 2,
    full_name: 'SANTOS / FLORIANÓPOLIS / SANTOS',
    status: 2
  },
  {
    id: 3,
  ...
  {
    id: 8,
    full_name: 'SANTOS / BUZIOS / ILHA BELA / SANTOS Fantasia',
    status: 1
  },
  {
    id: 9,
...
mock.onGet('/api/destinos/data').reply(() => {
  return [200, data]
})

mock.onGet('/api/destinos/data').reply(config => {
